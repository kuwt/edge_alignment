...
int edge_align_test5()
{
	...
	* ********************************************/
	...
	// transform o_X to a_X2
	//Eigen::Matrix<double, 4, 4> TransformPrior2;
	//TransformPrior2 = TransformFromFirstCam * TransformPrior * TransformFromFirstCamInv;

	//Eigen::MatrixXd a_X2;
	//a_X2 = Eigen::MatrixXd::Zero(4, verts.size());
	//a_X2 = TransformPrior2 * o_X;
